...
The first term pushes blood through the arterioles and capillaries. The third is the gradient for venous return described by Guyton (see the [Pmsf entry](/en/concepts/mean-systemic-filling-pressure/)). The middle term is the vascular waterfall itself: the pressure that is "lost" at the point where vessels close, and which therefore does not contribute to flow on either side. Castro, Pinsky and colleagues drew this profile explicitly in their 2026 review ([Castro et al., *J Crit Care* 2026](https://doi.org/10.1016/j.jcrc.2026.155485), Fig. 2).

<figure>
<img src="/img/castro2026-fig2.jpg" width="1600" height="797" alt="Pressure profile from aorta to vena cava: arterial pressure falls to the critical closing pressure (tissue perfusion pressure), drops across the vascular waterfall to the mean systemic filling pressure, then declines to central venous pressure (venous return driving pressure). Below, a schematic vessel from aorta through arterioles, capillaries and venules to vena cava." loading="lazy">
<figcaption>Pressure profile across the systemic circulation. Reproduced from Castro R, Retamal J, Hernández G, Kattan E, Pinsky MR. Critical closing pressure in the circulation: understanding the vascular waterfall phenomenon. <em>J Crit Care</em> 2026;93:155485, Fig. 2 (<a href="https://doi.org/10.1016/j.jcrc.2026.155485">doi:10.1016/j.jcrc.2026.155485</a>), under <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/">CC BY-NC-ND 4.0</a>. Unmodified.</figcaption>
</figure>

**Why the waterfall disconnects the two sides.** Permutt and Riley showed that once a collapsible vessel with tone is the limiting segment, flow depends only on the upstream pressure minus the closing pressure; the downstream pressure is irrelevant as long as it stays below the closing point ([Permutt & Riley, *J Appl Physiol* 1963](https://doi.org/10.1152/jappl.1963.18.5.924)). The lung offers the familiar analogy: in West's zone 2, flow is set by arterial minus alveolar pressure, and venous pressure does not enter ([West, Dollery & Naimark, *J Appl Physiol* 1964](https://doi.org/10.1152/jappl.1964.19.4.713)). In the systemic circulation the same logic separates an arterial pressure system from a venous one. Andrei and colleagues describe the waterfall as what "disconnects the arterial and the venous circulation in two pressure systems" ([Andrei et al., *Intensive Care Med Exp* 2023](https://doi.org/10.1186/s40635-023-00539-x)).
...
The mechanism of norepinephrine non-response is unknown; the authors note that no baseline parameter predicted it ([Andrei et al. 2023](https://doi.org/10.1186/s40635-023-00539-x)).

Estimates of Pcc from pulse pressure × heart rate have not been validated against stop-flow measurement; an accompanying editorial states that this accuracy "needs to be verified" ([Pinsky, *Anesthesiology* 2026](https://doi.org/10.1097/ALN.0000000000005908)). The waterfall model itself assumes steady state and a fixed Pcc, and its authors label several proposed mechanisms as informed speculation ([Castro et al. 2026](https://doi.org/10.1016/j.jcrc.2026.155485)).
