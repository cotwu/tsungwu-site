...
The first term pushes blood through the arterioles and capillaries. The third is the gradient for venous return described by Guyton (see the [Pmsf entry](/en/concepts/mean-systemic-filling-pressure/)). The middle term is the vascular waterfall itself: the pressure that is "lost" at the point where vessels close, and which therefore does not contribute to flow on either side. Castro, Pinsky and colleagues drew this profile explicitly in their 2026 review ([Castro et al., *J Crit Care* 2026](https://doi.org/10.1016/j.jcrc.2026.155485), Fig. 1).
